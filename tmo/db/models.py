...
class __BaseModel__(SQLModel):
    id: Optional[int] = Field(default=None, primary_key=True)

class _SubscriberBase(__BaseModel__):
    name: str
...
class _ChargesBase(__BaseModel__):
...
class _StatisticsBase(__BaseModel__):
